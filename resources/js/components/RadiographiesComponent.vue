    ...
    <div >
        ...
        <!-- <div class="card-body"> -->
            <div v-if="showradios">
                ...
                <button v-on:click="submitFile()" class="btn btn-primary pull-right rounded-0">AJOUTER</button>
            </div>
            <div v-else>
                <div class="alert alert-info"><i class="b badge-pill fa fa-info"></i>Aucune Radiographie enregistrée.</div>
            </div>        
        <!-- </div> -->
    </div>
</template>
