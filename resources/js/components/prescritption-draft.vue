                        ...
                        <tbody>
                            <tr v-for="(value,index) in patient.prescriptions">
                                ...
                                <td>
                                    ...
                                    <a :href="'/patients/prescription/'+value.id+'/print'" target="_blank"><button class="mr-2 btn-icon btn-icon-only btn btn-outline-secondary rounded-0" data-toggle="tooltip" data-placement="bottom" title="Imprimer la prescription"><i class="pe-7s-print btn-icon-wrapper"> </i></button></a>
...
export default {
    ...
    methods: {
        ...
        printPrescription(print = true, id = null) {
            ...
            if (this.editMode)
                axios
                    .put("/patients/prescription/" + this.id, this.form)
                    .then(response => {
                ...
                axios
                    .post("/patients/prescription", this.form)
                    .then(response => {
                        $("#modal_prescription").modal("hide");
                        ...
                        this.patient.prescriptions.push(
        ...
        removePrescription(index, id) {
            axios
                .delete("/patients/prescription/" + id)
                .then(response => {
