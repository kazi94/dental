  ...
  <div>
    ...
    >
      ...
      <template v-slot:cell(actions)="data">
        <b-dropdown right text="Actions" variant="outline-dark rounded-0">
          <b-dropdown-item :href="`/patient/${data.item.id}/edit`">Voir le patient</b-dropdown-item>
          <b-dropdown-item @click="removePatient(data.index ,data.item.id)">Supprimer</b-dropdown-item>
        </b-dropdown>
      </template>
    </b-table>
    <b-pagination
