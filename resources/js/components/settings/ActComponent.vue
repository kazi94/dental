<template>
    <div>
        <div class="row mb-1">
            <div class="col-sm-9 h5">Actes</div>
            <div class="col-sm-3">
                <button
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <form
                        ...
                        novalidate=""
                        @submit.prevent="editMode ? updateAct() : createAct()"
...
export default {
    ...
    methods: {
        ...
        createAct() {
            axios
                .post("/admin/act", this.form) // Send Ordonnance to server
                .then(response => {
                    //add act to list
        ...
        updateAct() {
            let acts = this.acts;
            axios
                .put("/admin/act/" + this.id, this.form)
                .then(response => {
                    $.each(acts, (index, val) => {
