    ...
    <div class="main-card mb-3 card">
      <div class="card-header">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a data-toggle="tab" href="#tab-eg1-0" class="nav-link">Plan</a>
          </li>
          <li class="nav-item">
            <a data-toggle="tab" href="#tab-eg1-2" class="nav-link">Devis</a>
          </li>
          <li class="nav-item">
      ...
      <div class="card-body">
        <div class="tab-content">
          ...
          <div class="tab-pane show" id="tab-eg1-3" role="tabpanel">
            <!-- <payment :patient="patient" v-if="showschema"></payment> -->
          </div>
        </div>
      </div>
    </div>
