...
<<<<<<< HEAD
    ...
    <div >
        ...
        <div class="modal fade"  tabindex="-1" id="modal_prescription"  role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title"><strong>Nouvelle Prescription</strong></h5>
                  ...
                  <form class="needs-validation" novalidate="" enctype="multipart/form-data">
                      <div class="modal-body">
                                ...
                                <table class="table table-bordered table-sm mb-0 mt-1">
                                    ...
                                    <tbody>
                                        <tr v-for="(val, index) in medicaments">
                                            <td>{{ index+1 }}</td>
                                            <td>{{ val.SP_NOM }}</td>
                                            <td><button class="btn btn-sm btn-danger " @click="remove($event,index)">X</button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-secondary rounded-0"  data-toggle="tooltip" data-placement="bottom" title="Valider et imprimer la prescription" @click="printPrescription">IMPRIMER</button>
                            <button type="button" class="btn btn-success rounded-0" data-toggle="tooltip" data-placement="bottom" title="Valider la prescription" @click="printPrescription(false)">VALIDER</button>
                        </div>  
                  </form>
              </div>
            </div>
...
=======
    <div class="main-card mb-3 card">
        <div class="card-body"><h5 class="card-title">Prescriptions</h5>
            <div class="table-responsive" v-show="showprescriptions">
                <table class="mb-0 table">
                    <thead>
                    <tr>
                        <th>#</th>
            ...
            <button class="btn btn-primary float-right mt-1" v-show="showprescriptions">AJOUTER</button>
        </div>
    ...
    components: {
		...
		methods : {
            ...
            printPrescription (print=true ,id=null) 
            {
                ...
                if (this.editMode)
                    axios.put('/patient/prescription/'+this.id , 
                        this.form,
                    )
                    .then( (response) => {
                        ...
                        //print Prescription
                        if (print)
                            openInNewTab('/patient/prescription/'+response.data.prescription.id+'/print');
                    ...
                    axios.post('/patient/prescription' , 
                        this.form,
                    )
                    .then( (response) => {
            ...
            removePrescription(index, id)
            {
                ...
                axios.delete('/patient/prescription/'+id)
                    .then((response) =>{
            ...
            editPrescription(id){
                ...
                axios.get('/patient/prescription/'+id)
                    .then((response) => {
