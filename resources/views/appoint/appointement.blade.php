...
<script src="/plugins/scheduler/codebase/ext/dhtmlxscheduler_tooltip.js" type="text/javascript" charset="utf-8">
  <script src="/plugins/scheduler/codebase/ext/dhtmlxscheduler_quick_info.js" type="text/javascript" charset="utf-8">
</script>
  ...
  function init($user_id = null) {
    ...
    scheduler.templates.event_text = function (start, end, event) {
      if (event.category != undefined && event.patient != undefined)
        return "Patient:<b> " + event.patient.nom + " " + event.patient.prenom + "</b><br>" + "Famille: " + event.category.name + "<br>Fauteuil N°:" + event.fauteuil;
      if (event.patient != undefined)
        return "Patient:<b> " + event.patient.nom + " " + event.patient.prenom + " </b><br>Fauteuil N°:" + event.fauteuil;
