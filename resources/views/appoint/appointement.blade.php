...
@endsection
@section('js_scripts')
    <script src="/plugins/scheduler/codebase/ext/dhtmlxscheduler_agenda_view.js?v=5.2.1" type="text/javascript"
        charset="utf-8"></script>
    <script src="/plugins/scheduler/codebase/ext/dhtmlxscheduler_quick_info.js?v=5.2.1" type="text/javascript"
        charset="utf-8"></script>
    <script src="/plugins/scheduler/codebase/ext/dhtmlxscheduler_readonly.js?v=5.2.1" type="text/javascript"
        charset="utf-8"></script>
    ...
    <script src='/plugins/scheduler/codebase/ext/dhtmlxscheduler_timeline.js' type="text/javascript" charset="utf-8">
    </script>
    <script src="/plugins/scheduler/codebase/ext/dhtmlxscheduler_units.js" type="text/javascript" charset="utf-8"></script>
    <script src="/plugins/scheduler/codebase/ext/dhtmlxscheduler_multiselect.js" type="text/javascript" charset="utf-8">
    </script>
    <script src="/plugins/scheduler/codebase/ext/dhtmlxscheduler_tooltip.js" type="text/javascript" charset="utf-8">
        < script src = "/plugins/scheduler/codebase/ext/dhtmlxscheduler_quick_info.js"
    ...
    scheduler.attachEvent("onBeforeViewChange", resetConfig);
		scheduler.attachEvent("onSchedulerResize", resetConfig); --}}
            ...
            scheduler.load("/rendez-vous/" + $user_id, "json");
            ...
            scheduler.form_blocks["my_editor2"] = {
                render: function(sns) {
                    ...
                    let html = "<div class='dhx_cal_ltext' style='height:60px;'>" +
                        "<select name='category_id' id='categories' style='width:277px; margin :5px;'>" + options +
                        "</select>" +
                        "</div>";
                    return html;
                },
                set_value: function(node, value, ev) {
                    node.querySelector("[name='category_id']").value = value || "";
                },
                get_value: function(node, ev) {
                    return node.querySelector("[name='category_id']").value;
                }
            };
            ...
            scheduler.templates.event_text = function(start, end, event) {
                if (event.category != undefined && event.patient != undefined)
                    return "Patient:<b> " + event.patient.nom + " " + event.patient.prenom + "</b><br>" + "Famille: " +
                        event.category.name + "<br>Fauteuil N°:" + event.fauteuil;
                if (event.patient != undefined)
                    return "Patient:<b> " + event.patient.nom + " " + event.patient.prenom + " </b><br>Fauteuil N°:" +
                        event.fauteuil;
            ...
            scheduler.templates.tooltip_text = function(start, end, event) {
                ...
                if (event.created_by.name)
                    created_by = "<b>Créer par :</b> " + event.created_by.name + " " + event.created_by.prenom +
                    "</b><br/>";
                if (event.assign_to)
            ...
            scheduler.templates.quick_info_content = function(start, end, event) {
                if (event.category != undefined)
                    return "Patient:<b> " + event.patient.nom + " " + event.patient.prenom + "</b><br>" + "Famille: " +
                        event.category.name + "<br>Fauteuil N°:" + event.fauteuil;
                return "Patient:<b> " + event.patient.nom + " " + event.patient.prenom + " </b><br>Fauteuil N°:" + event
                    .fauteuil;
            };
