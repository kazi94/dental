    ...
    (e._temp_matrix_scope = function() {
        ...
        function n(e, t) {
            if (((t[e.key] = e), e.children))
                for (var a = 0; a < e.children.length; a++) n(e.children[a], t);
        }
        function i(e) {
            for (
                var t = {}, a = e.y_unit_original || e.y_unit, i = 0;
                i < a.length;
                i++
            )
                n(a[i], t);
        ...
        function r(t, n) {
            ...
            for (var o = [], _ = 0; _ < n.y_unit.length; _++) o[_] = [];
            var d;
            o[d] || (o[d] = []);
            var s = i(n),
                l = "tree" == n.render;
            ...
            for (var c = n.y_property, _ = 0; _ < t.length; _++) {
                ...
                h.end_date.valueOf() == n._trace_x[v].valueOf() && (v -= 1),
                    o[d] || (o[d] = []),
                    r(o, d, g, v);
                var f = s[u];
                if (l && f && f.$parent)
        ...
        function d(t, a) {
            ...
            return (
                a.scrollable ||
                    (n = e.$container.querySelector(".dhx_cal_data")),
                n
            );
        }
        function s(e) {
        ...
        function l() {
            return e.$container.querySelector(
                ".dhx_cal_data .dhx_timeline_label_col"
            );
        }
        function c(t, a, n, i) {
            function r(e) {
            ...
            if (
                ...
                (h.addEventListener
                    ? "onwheel" in document
                        ? h.addEventListener("wheel", r)
                        : "onmousewheel" in document &&
                          h.addEventListener("mousewheel", r)
                    : h.attachEvent("onmousewheel", r),
                !h.$eventsAttached)
            ) {
                h.$eventsAttached = !0;
            ...
            var g;
            if (
                ((_.onscroll = function(r) {
                    var s = d(t, a),
                        h = s.scrollTop,
                        u = a.scrollHelper.getScrollValue(s),
                        v = e._timeline_smart_render.getViewPort(
                            a.scrollHelper,
                            0,
                            u,
                            h
                        ...
                        f = l();
                    if (
                        (a.scrollable && (f.style.top = -h + "px"),
                        !1 !== a.smart_rendering)
                    ) {
                        if (
                            ((u !== a._x_scroll || a._is_ev_creating) &&
                                (a.second_scale
                                    ? e._timeline_smart_render.updateHeader(
                                          a,
                                          v,
                                          c.children[1]
                                      )
                            ...
                            var m = +e.$container
                                ...
                                p =
                                    a._section_height[a.y_unit.length] +
                                    a._label_rows[a._label_rows.length - 1].top;
                            a.scrollHelper.getMode() ==
                                a.scrollHelper.modes.minMax &&
                            (p > m || "tree" == a.render)
                                ? (c.style.right = -1 - u - o() + "px")
                                : (c.style.right = -1 - u + "px"),
                                (c.style.left = "unset");
                        } else c.style.left = -1 - u + "px";
                        (a._options_changed ||
                            h !== a._y_scroll ||
                            a._is_ev_creating) &&
                            e._timeline_smart_render.updateLabels(a, v, f),
                            (a._is_ev_creating = !1),
                            e._timeline_smart_render.updateGridCols(a, v),
                            e._timeline_smart_render.updateGridRows(a, v);
                        var y = !1;
                        "cell" != a.render &&
                            (window.requestAnimationFrame
                                ? ((y = !0),
                                  ...
                                  (g = requestAnimationFrame(function() {
                                      a.name === e.getState().mode &&
                                          (e._timeline_smart_render.updateEvents(
                                              a,
                                              v
                                          ),
                                          (g = 0),
                                          a.callEvent("onScroll", [
                                              a.scrollHelper.getScrollValue(_),
                                              _.scrollTop
                                          ]));
                                  })))
                        ...
                        x =
                            "cell" === a.render
                                ? s.querySelectorAll(
                                      ".dhx_timeline_data_col .dhx_timeline_data_row"
                                  )
                                : s.querySelectorAll(
                                      ".dhx_timeline_data_col .dhx_matrix_line"
                                  );
                        ...
                        for (var w = 0, k = n.length; w < k; w++) b += n[w];
                        ...
                        var S = s.scrollTop,
                            ...
                            M =
                                a._summ -
                                e.$container.querySelector(".dhx_cal_data")
                                    .offsetWidth +
                                a.dx +
                                a.custom_scroll_width;
                        e._timeline_save_scroll_pos(a, S, N, M),
                ...
                _.$eventsAttached = !0;
                var v = { pageX: 0, pageY: 0 };
                _.addEventListener("touchstart", function(e) {
                    var t = e;
                    e.touches && (t = e.touches[0]),
                        (v = { pageX: t.pageX, pageY: t.pageY });
                }),
                    _.addEventListener("touchmove", function(t) {
                        ...
                        if (
                            ...
                            var d = Math.abs(r),
                                ...
                                h = d / c,
                                u = s / c;
                            h < 0.42 ? (r = 0) : u < 0.42 && (o = 0),
                                a.scrollHelper.setScrollValue(
                                    _,
                                    a.scrollHelper.getScrollValue(_) + r
                                ),
                                (_.scrollTop += o),
                                a.scrollable &&
                                    o &&
                                    (i.style.top = -_.scrollTop + "px");
                        }
                        return t && t.preventDefault && t.preventDefault(), !1;
                    });
            }
            a.scroll_position && a._is_new_view
                ? a.scrollTo(a.scroll_position)
                : e._timeline_set_scroll_pos(t, a),
                (a._is_ev_creating = !0);
        }
        function h(e, t) {
        ...
        function u(t, a) {
            var n = e.matrix[e._mode],
                ...
                o = a;
            for (
                i.x = t.touches ? t.touches[0].pageX : t.pageX,
                    i.y = t.touches ? t.touches[0].pageY : t.pageY,
                    r.left = o.offsetLeft + n.dx,
                    r.top = o.offsetTop;
                o;
                ...
                (r.left += o.offsetLeft),
                    (r.top += o.offsetTop),
                    (o = o.offsetParent);
            return { x: i.x - r.left, y: i.y - r.top };
        }
        function g(t) {
            S && clearInterval(S),
                (e._schedulerOuter = e.$container.querySelector(
        ...
        function v(t) {
            if (!e.getState().drag_id) return clearInterval(S), void (N = null);
            ...
            if (a) {
                ...
                (!c && !l) || N || ((N = { x: _, y: d }), (l = 0), (c = 0)),
                    (l *= s.speed_x),
                    (c *= s.speed_y),
                    l &&
                        c &&
                        (Math.abs(l / 5) > Math.abs(c)
                            ? (c = 0)
                            : Math.abs(c / 5) > Math.abs(l) && (l = 0)),
                    l || c ? ((N.started = !0), m(l, c)) : clearInterval(S);
            }
        }
        function f(e, t, a, n) {
            return e < n && (!N || N.started || e < a)
                ? -1
                : t - e < n && (!N || N.started || e > a)
                ? 1
                : 0;
        }
        function m(t, a) {
        ...
        var p = (function() {
            return function() {
                function e() {
                    ...
                    e.style.cssText =
                        "direction: rtl;overflow: auto;width:100px;height: 100px;position:absolute;top: -100500px;left: -100500px;";
                    var t = document.createElement("div");
                    return (
                        (t.style.cssText = "width: 100500px;height: 1px;"),
                        e.appendChild(t),
                        e
                    );
                }
                function t() {
                    ...
                    return (
                        ...
                        a.scrollLeft > 0
                            ...
                            : ((a.scrollLeft = -50),
                              (t =
                                  -50 === a.scrollLeft ? _.nMaxMin : _.maxMin)),
        ...
        (e.matrix = {}),
            ...
            (e.createTimelineView = function(a) {
                function n(a, n, i) {
                    ...
                    for (var s = [], l = 0; l < d.length; l++) {
                        var o = i.order[d[l]];
                        if (void 0 !== o && r[o]) s = s.concat(r[o]);
                        else if (r.undefined)
                    ...
                    return r.$matrix
                        ? ((o = r.$matrix[d][l] || []),
                          n &&
                              r.$matrix.$tree &&
                              r.$matrix.$tree[s.key] &&
                              (_ = r.$matrix.$tree[s.key][l] || []),
                          o.concat(_))
                        : r[d] || [];
                }
                function r(t, a, n) {
                    for (
                        var i = e.date[n.name + "_start"](new Date(t)),
                            r = 0,
                            o = i,
                            _ = n.x_step,
                            d = n.x_unit;
                ...
                e._skin_init(),
                    e._merge(a, {
                        ...
                        _logic: function(t, a, n) {
                            var i = {};
                            return (
                                e.checkEvent("onBeforeSectionRender") &&
                                    (i = e.callEvent("onBeforeSectionRender", [
                                        t,
                                        a,
                                        n
                                    ])),
                    ...
                    "day" != a.x_unit && (a.first_hour = a.last_hour = 0),
                    (a._start_correction = a.first_hour
                        ? 60 * a.first_hour * 60 * 1e3
                        : 0),
                    (a._end_correction = a.last_hour
                        ? 60 * (24 - a.last_hour) * 60 * 1e3
                        : 0),
                    e.checkEvent("onTimelineCreated") &&
                        e.callEvent("onTimelineCreated", [a]),
                    dhtmlxEventable(a);
                var _ = e.render_data;
                (e.render_data = function(t, n) {
                    if (this._mode != a.name) return _.apply(this, arguments);
                    if (n && !a.show_unassigned && "cell" != a.render)
                        for (var i = 0; i < t.length; i++)
                            this.clear_event(t[i]),
                                this.render_timeline_event.call(
                                    this.matrix[this._mode],
                                    t[i],
                                    !0
                                );
                    else e._renderMatrix.call(a, !0, !0);
                }),
                    (e.matrix[a.name] = a),
                    (e.templates[a.name + "_cell_value"] = function(e) {
                        return e ? e.length : "";
                    }),
                    ...
                    (e.templates[a.name + "_second_scalex_class"] = function(
                        e
                    ) {
                        return "";
                    }),
                    (e.templates[a.name + "_row_class"] = function(e, t) {
                        return t.folder_events_available && e.children
                            ? "folder"
                            : "";
                    }),
                    ...
                    (e.templates[a.name + "_date"] = function(t, a) {
                        return (t.getDay() == a.getDay() && a - t < 864e5) ||
                            +t == +e.date.date_part(new Date(a)) ||
                            (+e.date.add(t, 1, "day") == +a &&
                                0 === a.getHours() &&
                                0 === a.getMinutes())
                            ? e.templates.day_date(t)
                            : t.getDay() != a.getDay() && a - t < 864e5
                            ? e.templates.day_date(t) +
                              " &ndash; " +
                              e.templates.day_date(a)
                            : e.templates.week_date(t, a);
                    }),
                    (e.templates[a.name + "_scale_date"] = e.date.date_to_str(
                        a.x_date || e.config.hour_date
                    )),
                    (e.templates[
                        a.name + "_second_scale_date"
                    ] = e.date.date_to_str(
                        a.second_scale && a.second_scale.x_date
                            ? a.second_scale.x_date
                            : e.config.hour_date
                    )),
                    (e.date["add_" + a.name + "_private"] = function(t, n) {
                        var i = n,
                            r = a.x_unit;
                        if ("minute" == a.x_unit || "hour" == a.x_unit) {
                            var o = i;
                            "hour" == a.x_unit && (o *= 60),
                                o % 1440 || ((i = o / 1440), (r = "day"));
                        }
                        return e.date.add(t, i, r);
                    }),
                    (e.date["add_" + a.name] = function(t, n, i) {
                        var r = e.date["add_" + a.name + "_private"](
                            t,
                            (a.x_length || a.x_size) * a.x_step * n
                        );
                        if ("minute" == a.x_unit || "hour" == a.x_unit) {
                            ...
                            if ((_ * o) % 1440)
                                if (
                                    +e.date.date_part(new Date(t)) ==
                                    +e.date.date_part(new Date(r))
                                )
                                    a.x_start += n * o;
                                else {
                                    var d = 1440 / (o * _) - 1,
                    ...
                    (e.date[a.name + "_start"] = function(t) {
                        ...
                        return (
                            r != o && i.setTime(i.getTime() + 6e4 * (o - r)), i
                        );
                    }),
                    (a.scrollTo = e.bind(function(t) {
                        if (t) {
                            ...
                            var n = -1;
                            t.section
                                ? (n = this.posFromSection(t.section))
                                : t.top && (n = t.top);
                            var i;
                            if (
                                ((i =
                                ...
                                var r = +e.$container
                                    ...
                                    _ =
                                        ...
                                        this._label_rows[
                                            this._label_rows.length - 1
                                        ].top;
                                this.scrollHelper.getMode() ==
                                    this.scrollHelper.modes.minMax &&
                                    (_ > r || "tree" == this.render) &&
                                    (i -= o());
                            }
                            var d = e.$container.querySelector(
                                ".dhx_timeline_data_wrapper"
                            );
                            this.scrollable ||
                                (d = e.$container.querySelector(
                                    ".dhx_cal_data"
                                )),
                                this.scrollable &&
                                    this.scrollHelper.setScrollValue(d, i),
                                n > 0 && (d.scrollTop = n);
                        }
                    }, a)),
                    (a.getScrollPosition = e.bind(function() {
                        return {
                            left: this._x_scroll || 0,
                            top: this._y_scroll || 0
                        };
                    }, a)),
                    (a.posFromDate = e.bind(function(t) {
                        return (
                            e._timeline_getX({ start_date: t }, !1, this) - 1
                        );
                    }, a)),
                    (a.posFromSection = e.bind(function(e) {
                        var t = this.order[e];
                    ...
                    (a.selectEvents = e.bind(function(e) {
                        var t = e.section,
                            a = e.date,
                            r = e.selectNested;
                        return a
                    ...
                    (a.setRange = e.bind(function(t, a) {
                        var n = e.date[this.name + "_start"](new Date(t)),
                            i = r(t, a, this);
                        (this.x_size = i), e.setCurrentView(n, this.name);
                    }, a)),
                    e.callEvent("onOptionsLoad", [a]),
                    (e[a.name + "_view"] = function(t) {
                        t
                            ? e._set_timeline_dates(a)
                            : e._renderMatrix.apply(a, arguments);
                    });
                var d = new Date();
                ...
                e["mouse_" + a.name] = function(t) {
                    ...
                    if (
                        (this._drag_id && (n = this.getEvent(this._drag_id)),
                        a.scrollable && !t.converted)
                    ) {
                        if (
                            ((t.converted = 1),
                            (t.x += -a.dx + a._x_scroll),
                            e.config.rtl)
                        ) {
                            var i = +e.$container
                                    .querySelector(
                    ...
                    if (
                        ...
                        if (
                            ...
                            void 0 === d._move_delta &&
                                ((d._move_delta = (n.start_date - _) / 6e4),
                                this.config.preserve_length &&
                                    t._ignores &&
                                    ((d._move_delta = this._get_real_event_length(
                                        n.start_date,
                                        _,
                                        a
                                    )),
                            ...
                            this.config.preserve_length && t._ignores)
                        ) {
                            var s =
                                (d._event_length,
                            ...
                            _ = new Date(_ - s);
                        } else _ = e.date.add(_, d._move_delta, "minute");
                    }
                    if (
                        ("resize" == this._drag_mode &&
                            n &&
                            (this.config.timeline_swap_resize &&
                                this._drag_id &&
                                (this._drag_from_start && +_ > +n.end_date
                                    ? (this._drag_from_start = !1)
                                    : !this._drag_from_start &&
                                      +_ < +n.start_date &&
                                      (this._drag_from_start = !0)),
                            (t.resize_from_start = this._drag_from_start),
                            !this.config.timeline_swap_resize &&
                                this._drag_id &&
                                this._drag_from_start &&
                                +_ >=
                        ...
                        switch (this._drag_mode) {
                            case "move":
                                this.config.preserve_length ||
                                    ((_ = e._timeline_get_rounded_date.call(
                                        a,
                                        _,
                                        !1
                                    )),
                                    "day" == a.x_unit && (t.custom = !1));
                                break;
                            case "resize":
                                this._drag_event &&
                                    ((null !==
                                        this._drag_event._resize_from_start &&
                                        void 0 !==
                                            this._drag_event
                                                ._resize_from_start) ||
                                        (this._drag_event._resize_from_start =
                                            t.resize_from_start),
                                    (t.resize_from_start = this._drag_event._resize_from_start),
                                    (_ = e._timeline_get_rounded_date.call(
                                        a,
                                        _,
                                        !this._drag_event._resize_from_start
                    ...
                    this._resolve_timeline_section(a, t),
                        t.section &&
                            this._update_timeline_section({
                                pos: t,
                                event: this.getEvent(this._drag_id),
                                view: a
                            }),
                        (t.y = Math.round(
                            (this._correct_shift(_, 1) - this._min_date) /
                                (6e4 * this.config.time_step)
                        )),
                        (t.shift = this.config.time_step),
                        a.round_position &&
                            "new-size" == this._drag_mode &&
                            _ <= this._drag_start &&
                            (t.shift =
                                e.date.add(
                                    this._drag_start,
                    ...
                    return (
                        ...
                        l || this._drag_pos.has_moved || (t.force_redraw = !1),
                        t
                    );
                };
            }),
            (e._prepare_timeline_events = function(t) {
                ...
                if ("cell" == t.render) a = e._timeline_trace_events.call(t);
                    ...
                    for (
                        var n = e.get_visible_events(), i = t.order, r = 0;
                        r < n.length;
                        r++
                    ) {
                        var o = n[r],
            ...
            (e._populate_timeline_rendered = function(t) {
                e._rendered = [];
                for (
                    var a = t.querySelectorAll("div[event_id]"), n = 0;
                    n < a.length;
                    n++
                )
            ...
            (e._get_timeline_event_height = function(e, t) {
                ...
                return (
                    "full" == t.event_dy &&
                        (n = t.section_autoheight
                            ? t._section_height[a] - 6
                            : t.dy - 3),
                    t.resize_events &&
                        (n = Math.max(
                            Math.floor(n / (e._count || 1)),
                            t.event_min_dy
                        )),
                    n
                );
            ...
            (e._get_timeline_event_y = function(t, a) {
                ...
                return (
                    e.config.cascade_event_display &&
                        (i =
                            2 +
                            n * e.config.cascade_event_margin +
                            (n ? 2 * n : 0)),
                    i
                );
            }),
            (e.render_timeline_event = function(t, a) {
                ...
                var s = e._get_timeline_event_y(t._sorder, _),
                    l = _ + s + 2;
                (!this._events_height[n] || this._events_height[n] < l) &&
                    (this._events_height[n] = l);
                var c = e.templates.event_class(t.start_date, t.end_date, t);
                (c = "dhx_cal_event_line " + (c || "")),
                    e.getState().select_id == t.id &&
                ...
                var h = t.color ? "background:" + t.color + ";" : "",
                    ...
                    v =
                        "<div " +
                        e._waiAria.eventBarAttrString(t) +
                        " event_id='" +
                        t.id +
                        "' class='" +
                        c +
            ...
            (e._timeline_getX = function(t, a, n) {
                ...
                if (s > 0) {
                    ...
                    o
                        ? +d > +h && a && (_ = e._cols[l])
                        : ((s = d - h),
                          n.first_hour || n.last_hour
                              ? ((s -= n._start_correction),
                                s < 0 && (s = 0),
                                (_ = Math.round(s / r)) > e._cols[l] &&
                                    (_ = e._cols[l]))
                              : (_ = Math.round(s / r)));
                }
                ...
                if (e._ignores_detected)
                    for (var a, n, i, r, o = 0; o < t.length; o++) {
                        for (
                            r = t[o],
                                i = !1,
                                a = e._get_date_index(this, r.start_date),
                                n = e._get_date_index(this, r.end_date);
                            a < n;
                        ...
                        i ||
                            a != n ||
                            e._ignores[n] ||
                            (+r.end_date > +this._trace_x[n] && (i = !0)),
                            i || (t.splice(o, 1), o--);
                    }
            }),
                ...
                if (t && "cell" != this.render) {
                    e._timeline_skip_ignored.call(this, t),
                        t.sort(
                            this.sort ||
                                function(e, t) {
                                    return e.start_date.valueOf() ==
                                        t.start_date.valueOf()
                                        ? e.id > t.id
                                            ? 1
                                            : -1
                    ...
                    for (
                        var a = [], n = t.length, i = -1, r = null, o = 0;
                        o < n;
                        o++
                    ) {
                        var _ = t[o];
                        _._inner = !1;
                        var d = this.round_position
                            ? e._timeline_get_rounded_date.apply(this, [
                                  _.start_date,
                                  !1
                              ])
                            : _.start_date;
                        ...
                        if ((a.length && (a[a.length - 1]._inner = !0), !s))
                            if (a.length)
                ...
                if (t && "cell" != this.render) {
                    ...
                    t.forEach(function(e) {
                        ...
                        e._rendered.forEach(function(e) {
                            if (e.parentNode) {
                                var t = e.parentNode.getAttribute(
                                    "data-section-id"
                                );
                                i[r(e.getAttribute("event_id"), t)] &&
            ...
            (e._timeline_get_block_stats = function(t, a) {
                ...
                return (
                    ...
                    (n.style_data_wrapper =
                        (e.config.rtl ? "padding-right:" : "padding-left:") +
                        a.dx +
                        "px;"),
                    (n.style_label_wrapper = "width: " + a.dx + "px;"),
                    a.scrollable
                        ? ((n.style_data_wrapper +=
                              "height:" + (a._sch_height - 1) + "px;"),
                          void 0 === a.html_scroll_width &&
                              (a.html_scroll_width = o()),
                          a._section_autowidth
                              ? (a.custom_scroll_width = 0)
                              : (a.custom_scroll_width = a.html_scroll_width),
                          (n.style_label_wrapper +=
                              "height:" +
                              (a._sch_height - 1 - a.custom_scroll_width) +
                              "px;"))
                        : ((n.style_data_wrapper +=
                              "height:" + (a._sch_height - 1) + "px;"),
                          (n.style_label_wrapper +=
            ...
            (e._timeline_get_cur_row_stats = function(t, a) {
                ...
                if ((e._merge(n, { height: t.dy }), t.section_autoheight)) {
                    var i = t.scrollable
                        ? t._sch_height - e.xy.scroll_width
                        : t._sch_height;
                    t.y_unit.length * n.height < i &&
                        (n.height = Math.max(
                            n.height,
                ...
                return (
                    ...
                    n.td_className ||
                        (n.td_className =
                            "dhx_matrix_scell" +
                            (e.templates[t.name + "_scaley_class"](
                                t.y_unit[a].key,
                                t.y_unit[a].label,
                                t.y_unit[a]
                            )
                                ...
                                : "")),
                    n.td_content ||
                        (n.td_content = e.templates[t.name + "_scale_label"](
                            t.y_unit[a].key,
                            t.y_unit[a].label,
                            t.y_unit[a]
                        )),
            ...
            (e._timeline_get_fit_events_stats = function(e, t, a) {
                if (e.fit_events) {
                    ...
                    (a.height = n > a.height ? n : a.height),
                        (a.style_height = "height:" + a.height + "px;"),
                        (a.style_line_height =
                            "line-height:" + (a.height - 1) + "px;"),
                        (e._section_height[e.y_unit[t].key] = a.height);
                }
                return (
                    (a.style_height = "height:" + a.height + "px;"),
                    (a.style_line_height =
            ...
            (e._timeline_set_scroll_pos = function(e, t) {
                ...
                (a.scrollTop = t._y_scroll || 0),
                    t.scrollHelper.setScrollValue(a, t._x_scroll || 0),
                    t.scrollHelper.getMode() != t.scrollHelper.modes.maxMin &&
                        a.scrollLeft == t._summ - a.offsetWidth + t.dx &&
                        (a.scrollLeft += o());
            }),
            (e._timeline_save_scroll_pos = function(e, t, a, n) {
                (e._y_scroll = t || 0), (e._x_scroll = a || 0);
            }),
            (e._timeline_get_html_for_cell_data_row = function(e, t, a, n, i) {
                var r = "";
                return (
                    i.template &&
                        (r += " " + (i.template(i.section, i.view) || "")),
                    "<div class='dhx_timeline_data_row" +
                        r +
                        "' data-section-id='" +
                        n +
                        "' data-section-index='" +
            ...
            (e._timeline_get_html_for_cell_ignores = function(e) {
                return (
                    '<div class="dhx_matrix_cell dhx_timeline_data_cell" style="' +
                    e.style_height +
                    e.style_line_height +
                    ';display:none"></div>'
                );
            ...
            (e._timeline_get_html_for_cell = function(t, a, n, i, r, o) {
                ...
                return (
                    ...
                    e.templates[n.name + "_cell_class"](i, d, s) +
                    "' style='width:" +
                    l +
                    "px;" +
                    r.style_height +
            ...
            (e._timeline_get_html_for_bar_data_row = function(e, t) {
                var a = e.table_className;
                return (
                    t.template &&
                        (a += " " + (t.template(t.section, t.view) || "")),
                    "<div class='dhx_timeline_data_row " +
                        a +
                        "' style='" +
                        e.summ_width +
            ...
            (e._timeline_get_html_for_bar = function(t, a, n, i, r, o) {
                var d = _(n._trace_x[t]),
                    ...
                    l = "";
                n.cell_template &&
                    (l = e.templates[n.name + "_cell_value"](
                        i,
                        n._trace_x[t],
                        s,
                        o
                ...
                return (
                    "<div class='dhx_matrix_cell dhx_timeline_data_cell " +
                    e.templates[n.name + "_cell_class"](
                        i,
                        n._trace_x[t],
                        s,
                        o
                ...
                if ((n && n.parentNode.removeChild(n), a)) {
                    ...
                    (n.className = i),
                        (n.style.cssText = [
                            ...
                            "height:" + r + "px",
                            "line-height:" + r + "px",
                            "top:" + (e.xy.nav_height + 2) + "px",
                            e.config.rtl ? "right:0" : "left:0"
                        ].join(";")),
                        (n.innerHTML =
                            e.locale.labels[t.name + "_scale_header"] || ""),
            ...
            (e._timeline_y_scale = function(t) {
                var a = e._timeline_get_block_stats(t, this),
                    ...
                    r =
                        "<div class='dhx_timeline_label_wrapper' style='" +
                        a.style_label_wrapper +
                        "'><div class='dhx_timeline_label_col'>",
                    o =
                        "<div class='dhx_timeline_data_wrapper" +
                        n +
                        "' style='" +
                        a.style_data_wrapper +
                        "'><div class='dhx_timeline_data_col'>";
                e._load_mode && e._load(),
                    e._timeline_smart_render.clearPreparedEventsCache(_);
                ...
                (l =
                    (e.date.add(l, this.x_step * h, this.x_unit) -
                        l -
                        (this._start_correction + this._end_correction) * h) /
                    d),
                    (this._step = l),
                    (this._summ = d);
                ...
                var v = !1,
                    f = 0,
                    m = null;
                (this.scrollable || this.smart_rendering) &&
                    (m = e._timeline_smart_render.getViewPort(
                        this.scrollHelper,
                        this._sch_height
                    )),
                ...
                var p,
                    y = !!m;
                p = this.scrollable
                    ? !1 !== this.smart_rendering && !!y
                    : !!this.smart_rendering && y;
                for (var b = [], x = 0, w = 0; w < this.y_unit.length; w++) {
                    e._timeline_calculate_event_positions.call(this, _[w]);
                    var k = e._timeline_get_cur_row_stats(this, w);
                    (k = e._timeline_get_fit_events_stats(this, w, k)),
                        b.push(k),
                        (x += k.height);
                }
                m &&
                    x < m.scrollTop &&
                    (m.scrollTop = Math.max(0, x - m.height));
                for (var w = 0; w < this.y_unit.length; w++) {
                    var k = b[w],
                        D = this.y_unit[w],
                        E =
                            "<div class='dhx_timeline_label_row " +
                            k.tr_className +
                            "' style='top:" +
                            f +
                            "px;" +
                            ...
                            k.height +
                            "px;' " +
                            e._waiAria.label(k.td_content) +
                            ">" +
                            k.td_content +
                            "</div></div>";
                    if (
                        (p &&
                            this._label_rows.push({
                                div: E,
                                top: f,
                                section: D
                            }),
                        p &&
                            (e._timeline_smart_render.isInYViewPort(
                                { top: f, bottom: f + k.height },
                                m
                            ) ||
                                (v = !0)),
                        (f += k.height),
                        ...
                        (r += E),
                            p &&
                                e._timeline_smart_render._rendered_labels_cache.push(
                                    w
                                );
                        var S = e.templates[this.name + "_row_class"],
                            N = { view: this, section: D, template: S },
                            M = 0;
                        if ("cell" == this.render) {
                            o += e._timeline_get_html_for_cell_data_row(
                                w,
                                k,
                                f - k.height,
                                D.key,
                            ...
                            for (var A = 0; A < e._cols.length; A++)
                                e._ignores[A] && !p
                                    ? (o += e._timeline_get_html_for_cell_ignores(
                                          k
                                      ))
                                    : p && y
                                    ? e._timeline_smart_render.isInXViewPort(
                                          { left: M, right: M + e._cols[A] },
                                          m
                                      ) &&
                                      (o += e._timeline_get_html_for_cell(
                                          A,
                                          w,
                                          this,
                                          _[w][A],
                            ...
                            o += e._timeline_get_html_for_bar_matrix_line(
                                w,
                                k,
                                f - k.height,
                                D.key
                            ...
                            p &&
                                y &&
                                (C = e._timeline_smart_render.getVisibleEventsForRow(
                                    this,
                                    m,
                                    _,
                                    w
                            ...
                            (o += e._timeline_get_events_html.call(this, C)),
                                (o += e._timeline_get_html_for_bar_data_row(
                                    k,
                                    N
                                ));
                            for (var A = 0; A < e._cols.length; A++)
                                e._ignores[A]
                                    ? (o += e._timeline_get_html_for_bar_ignores())
                                    : p && y
                                    ? e._timeline_smart_render.isInXViewPort(
                                          { left: M, right: M + e._cols[A] },
                                          m
                                      ) &&
                                      (o += e._timeline_get_html_for_bar(
                                          A,
                                          w,
                                          this,
                                          _[w],
                ...
                for (var s = 0, T = g.length; s < T; s++) {
                    u.push(g[s].height);
                    var O = g[s].sectionKey;
                    e._timeline_finalize_section_add(this, O, t);
                }
                p &&
                    e._timeline_smart_render &&
                    (e._timeline_smart_render._rendered_events_cache = []),
                    (p || this.scrollable) && c(t, this, u, g);
            }),
            (e._timeline_finalize_section_add = function(t, a, n) {
                var i = (t._scales[a] = n.querySelector(
                    ".dhx_timeline_data_col [data-section-id='" + a + "']"
                ));
            ...
            e.attachEvent("onBeforeViewChange", function(t, a, n, i) {
                if (e.matrix[n]) {
                    var r = e.matrix[n];
                    if (r.scrollable) {
                        if ("tree" == r.render && t === n && a === i) return !0;
                        (r._x_scroll = r._y_scroll = 0),
                            e.$container.querySelector(
                                ".dhx_timeline_scrollable_data"
                            ) &&
                                e._timeline_set_scroll_pos(
                                    e._els.dhx_cal_data[0],
                                    r
                                );
                    }
                }
            ...
            (e._timeline_x_dates = function(t) {
                ...
                for (
                    var i = (this.x_size, t && e._ignores_detected, 0), r = 0;
                    +a < +n;

                )
                    if (
                        ((this._trace_x[r] = new Date(a)),
                        "month" == this.x_unit &&
                            e.date[this.x_unit + "_start"] &&
                            (a = e.date[this.x_unit + "_start"](new Date(a))),
                        (a = e.date.add(a, this.x_step, this.x_unit)),
                        e.date[this.x_unit + "_start"] &&
                            (a = e.date[this.x_unit + "_start"](a)),
                        e._ignores[r] || i++,
                        r++,
                        t)
                    )
                        if (i < this.x_size && !(+a < +n))
                            n = e.date["add_" + this.name + "_private"](
                                n,
                                (this.x_length || this.x_size) * this.x_step
                            );
            ...
            (e._timeline_x_scale = function(t) {
                ...
                for (
                    var d = (e._min_date_timeline = e._min_date),
                        s = e.config.preserve_scale_length,
                        l = e._timeline_x_dates.call(this, s),
                        c = l.displayed,
                        h = l.total,
                        u = 0;
                    u < h;
                    ...
                    e._ignores[u]
                        ? ((e._cols[u] = 0), c++)
                        : (e._cols[u] = Math.floor(i / (c - u))),
                        (i -= e._cols[u]),
                        (o[u + 1] = o[u] + e._cols[u]);
                if (((t.innerHTML = "<div></div>"), this.second_scale)) {
                    for (
                        var g = this.second_scale.x_unit,
                            v = [this._trace_x[0]],
                            f = [],
                            m = [this.dx, this.dx],
                            p = 0,
                            y = 0;
                        y < this._trace_x.length;
                        y++
                    ) {
                        var b = this._trace_x[y];
                        e._timeline_is_new_interval(g, b, v[p]) &&
                            (++p, (v[p] = b), (m[p + 1] = m[p]));
                        var x = p + 1;
                    ...
                    (k.style.position = "relative"),
                        (k.className = "dhx_bottom_scale_container");
                    for (var D = 0; D < v.length; D++) {
                        var E = v[D],
                            S = e.templates[this.name + "_second_scalex_class"](
                                E
                            ),
                            N = document.createElement("div");
                        (N.className =
                            ...
                            (S ? " " + S : "")),
                            e.set_xy(N, f[D] - 1, n - 3, m[D], 0),
                            (N.innerHTML = e.templates[
                                this.name + "_second_scale_date"
                            ](E)),
                            w.appendChild(N);
                    }
                }
                ...
                for (var M = 0; M < this._trace_x.length; M++)
                    if (!e._ignores[M]) {
                        (d = this._trace_x[M]),
                            e._render_x_header(M, o[M], d, t);
                        var A = e.templates[this.name + "_scalex_class"](d);
                        A && (t.lastChild.className += " " + A),
                            t.lastChild.setAttribute("data-col-id", M),
                            t.lastChild.setAttribute("data-col-date", _(d));
                        var C = t.lastChild.cloneNode(!0);
                        this._h_cols[M] = { div: C, left: o[M] };
                    }
                e.xy.scale_height = a;
                var T = this._trace_x;
                (t.onclick = function(t) {
                    ...
                    a &&
                        e.callEvent("onXScaleClick", [a.x, T[a.x], t || event]);
                }),
                    (t.ondblclick = function(t) {
                        var a = e._timeline_locate_hcell(t);
                        a &&
                            e.callEvent("onXScaleDblClick", [
                                a.x,
                                T[a.x],
                                t || event
                            ]);
                ...
                switch (t) {
                    case "hour":
                        return (
                            ...
                            e._timeline_is_new_interval("day", a, n)
                        );
                    case "day":
                        return !(
                            a.getDate() == n.getDate() &&
                    ...
                    case "week":
                        return !(
                            e.date.week_start(new Date(a)).valueOf() ==
                            e.date.week_start(new Date(n)).valueOf()
                        );
                    case "month":
                        return !(
                            a.getMonth() == n.getMonth() &&
            ...
            (e._timeline_set_full_view = function(t) {
                if ((e._timeline_reset_scale_height.call(this, t), t)) {
                    this.second_scale &&
                        !this._header_resized &&
                        ((this._header_resized = e.xy.scale_height),
                        (e.xy.scale_height *= 2),
                        (e._els.dhx_cal_header[0].className +=
                            " dhx_second_cal_header")),
                        e.set_sizes(),
                        e._init_matrix_tooltip();
                    var a = e._min_date;
                    if (
                        (e._timeline_x_scale.call(
                            this,
                            e._els.dhx_cal_header[0]
                        ),
                        e.$container.querySelector(
                            ".dhx_timeline_scrollable_data"
                        ))
                    ) {
                        var n = e._timeline_smart_render.getViewPort(
                                this.scrollHelper
                            ),
                            i = e._timeline_smart_render.getVisibleHeader(
                                this,
                                n
                            );
                        i &&
                            (this.second_scale
                                ? (e._els.dhx_cal_header[0].children[1].innerHTML = i)
                                : (e._els.dhx_cal_header[0].children[0].innerHTML = i));
                    }
                    e._timeline_y_scale.call(this, e._els.dhx_cal_data[0]),
                        (e._min_date = a);
                    var r = e._getNavDateElement();
                    r &&
                        (r.innerHTML = e.templates[this.name + "_date"](
                            e._min_date,
                            e._max_date
                        )),
            ...
            (e._timeline_showToolTip = function(t, a, n) {
                if ("cell" == t.render) {
                    ...
                    for (var _ = "", d = 0; d < r.length; d++) {
                        var s = r[d].color
                                ? "background-color:" + r[d].color + ";"
                                : "",
                            l = r[d].textColor
                                ? "color:" + r[d].textColor + ";"
                                : "";
                        (_ +=
                            "<div class='dhx_tooltip_line' event_id='" +
                            r[d].id +
                            "' style='" +
                            s +
                            l +
                            "'>"),
                            (_ +=
                                "<div class='dhx_tooltip_date'>" +
                                (r[d]._timed
                                    ? e.templates.event_date(r[d].start_date)
                                    : "") +
                                "</div>"),
                            (_ +=
                                "<div class='dhx_event_icon icon_details'>&nbsp;</div>"),
                            (_ +=
                                e.templates[t.name + "_tooltip"](
                                    r[d].start_date,
                                    r[d].end_date,
                                    r[d]
                                ) + "</div>");
                    ...
                    (e._tooltip.style.display = ""),
                        ...
                        (e.config.rtl &&
                            n.left - e._tooltip.offsetWidth >= 0) ||
                        document.body.offsetWidth -
                            a.src.offsetWidth -
                            n.left -
                            e._tooltip.offsetWidth <
                            0
                            ? (e._tooltip.style.left =
                                  n.left - e._tooltip.offsetWidth + "px")
                            : (e._tooltip.style.left =
                                  n.left + a.src.offsetWidth + "px"),
                        (e._tooltip.date = i),
                        (e._tooltip.innerHTML = _),
                        document.body.offsetHeight -
                            n.top -
                            e._tooltip.offsetHeight <
                        0
                            ? (e._tooltip.style.top =
                                  n.top -
                                  e._tooltip.offsetHeight +
                                  a.src.offsetHeight +
                                  "px")
                            : (e._tooltip.style.top = n.top + "px");
                }
            }),
            (e._matrix_tooltip_handler = function(t) {
                ...
                if (a && "cell" == a.render) {
                    if (a) {
                        ...
                        if (n)
                            return e._timeline_showToolTip(
                                a,
                                n,
                                e.$domHelpers.getOffset(n.src)
                            );
                    }
                    e._timeline_hideToolTip();
                }
            ...
            (e._set_timeline_dates = function(t) {
                (e._min_date = e.date[t.name + "_start"](new Date(e._date))),
                    (e._max_date = e.date["add_" + t.name + "_private"](
                        e._min_date,
                        t.x_size * t.x_step
                    )),
                    e.date[t.x_unit + "_start"] &&
                        (e._max_date = e.date[t.x_unit + "_start"](
                            e._max_date
                        )),
                    (e._table_view = !0);
            }),
            ...
            (e._timeline_html_index = function(t) {
                for (
                    var a = t.parentNode.childNodes, n = -1, i = 0;
                    i < a.length;
                    i++
                )
                    if (a[i] == t) {
            ...
            (e._locate_cell_timeline = function(t) {
                ...
                for (
                    var a = t.target ? t.target : t.srcElement,
                        ...
                        _ = 0,
                        d = 0;
                    d < i._trace_x.length - 1 && !(+r.date < i._trace_x[d + 1]);
                    d++
                )
                    o[d] || _++;
                ...
                if (i.scrollable && "cell" === i.render) {
                    if (
                        !i._scales[r.section] ||
                        !i._scales[r.section].querySelector(".dhx_matrix_cell")
                    )
                        return;
                    var l = i._scales[r.section].querySelector(
                        ".dhx_matrix_cell"
                    );
                    if (!l) return;
                    var c = l.offsetLeft;
                    if (c > 0) {
                        for (
                            var u = e._timeline_drag_date(i, c), g = 0;
                            g < i._trace_x.length - 1 &&
                            !(+u < i._trace_x[g + 1]);
                            g++
                        );
                        s = g;
                ...
                n.src = i._scales[r.section]
                    ? i._scales[r.section].querySelectorAll(".dhx_matrix_cell")[
                          d - s
                      ]
                    : null;
                var v = !1,
                ...
                return (
                    f && ((a = f), (v = !0)),
                    v ? ((n.x = -1), (n.src = a), (n.scale = !0)) : (n.x = d),
                    n
                );
            });
        ...
        (e._click.dhx_marked_timespan = e._click.dhx_cal_data = function(t) {
            ...
            if (n) {
                ...
                i &&
                    (i.scale
                        ? e.callEvent("onYScaleClick", [
                              i.y,
                              n.y_unit[i.y],
                              t || event
                          ])
                        : (e.callEvent("onCellClick", [
                              i.x,
                              i.y,
                              n._trace_x[i.x],
                              (n._matrix[i.y] || {})[i.x] || [],
            ...
            (e.dblclick_dhx_matrix_cell = function(t) {
                ...
                if (a) {
                    ...
                    n &&
                        (n.scale
                            ? e.callEvent("onYScaleDblClick", [
                                  n.y,
                                  a.y_unit[n.y],
                                  t || event
                              ])
                            : e.callEvent("onCellDblClick", [
                                  n.x,
                                  n.y,
                                  a._trace_x[n.x],
                                  (a._matrix[n.y] || {})[n.x] || [],
        ...
        (e.dblclick_dhx_marked_timespan = function(t) {
            return e.matrix[e._mode]
                ? e.dblclick_dhx_matrix_cell(t)
            ...
            e.attachEvent("onCellDblClick", function(t, a, n, i, r) {
                if (
                    ...
                    ("dblclick" != r.type || this.config.dblclick_create)
                ) {
                    var o = e.matrix[e._mode],
                        _ = {};
                    (_.start_date = o._trace_x[t]),
                        (_.end_date = o._trace_x[t + 1]
                            ? o._trace_x[t + 1]
                            : e.date.add(o._trace_x[t], o.x_step, o.x_unit)),
                        o._start_correction &&
                            (_.start_date = new Date(
                                1 * _.start_date + o._start_correction
                            )),
                        o._end_correction &&
                            (_.end_date = new Date(
                                _.end_date - o._end_correction
                            )),
                        (_[o.y_property] = o.y_unit[a].key),
                        e.addEventNow(_, null, r);
                }
            }),
            ...
            e.attachEvent("onBeforeEventChanged", function(e, t, a, n) {
                return (
                    e && (e._move_delta = void 0),
                    n && (n._move_delta = void 0),
                    !0
                );
            }),
        ...
        e._render_marked_timespan = function(t, a, n, i, r) {
            ...
            if (e.matrix && e.matrix[e._mode]) {
                ...
                var _ = [],
                    ...
                    s = [],
                    l = t.sections
                        ? t.sections.units || t.sections.timeline
                        : null;
                if (n) (s = [a]), (d = [n]);
                else {
                    var c = o.order;
                    if (l)
                        c.hasOwnProperty(l) &&
                            (d.push(l), s.push(o._scales[l]));
                    else if (o._scales)
                        for (var h in c)
                            c.hasOwnProperty(h) &&
                                o._scales[h] &&
                                (d.push(h), s.push(o._scales[h]));
                }
                var i = i ? new Date(i) : e._min_date,
                    r = r ? new Date(r) : e._max_date;
                if (
                    (i.valueOf() < e._min_date.valueOf() &&
                        (i = new Date(e._min_date)),
                    r.valueOf() > e._max_date.valueOf() &&
                        (r = new Date(e._max_date)),
                    !o._trace_x)
                )
                    return;
                for (
                    var u = 0;
                    u < o._trace_x.length &&
                    !e._is_column_visible(o._trace_x[u]);
                    u++
                );
                if (u == o._trace_x.length) return;
                var g = [];
                if (t.days > 6) {
                    var v = new Date(t.days);
                    e.date.date_part(new Date(i)) <= +v &&
                        +r >= +v &&
                        g.push(v);
                } else g.push.apply(g, e._get_dates_by_index(t.days));
                for (
                    var f = t.zones, m = e._get_css_classes_by_config(t), p = 0;
                    p < d.length;
                    p++
                ) {
                    (a = s[p]), (n = d[p]);
        ...
        (e._on_scale_add_marker = function(t, a) {
                ...
                if (i && e.matrix && e.matrix[e._mode])
                    for (
                        ...
                        var l = +s,
                            ...
                            u = d[l] || d[c];
                        if (
                            (h.push.apply(h, e._get_configs_to_render(u)),
                            i[r] && i[r][a])
                        ) {
                            var g = [],
                                v = e._get_types_to_render(
                                    i[r][a][c],
                                    i[r][a][l]
                                );
                            g.push.apply(g, e._get_configs_to_render(v)),
                                g.length && (h = g);
                        }
            ...
            (e._resolve_timeline_section = function(e, t) {
                ...
                for (
                    a;
                    a < this._colsS.heights.length &&
                    !((n += this._colsS.heights[a]) > t.y);
                    a++
                );
                e.y_unit[a] || (a = e.y_unit.length - 1),
                    this._drag_event &&
                        !this._drag_event._orig_section &&
                        (this._drag_event._orig_section = e.y_unit[a].key),
                    (t.fields = {}),
                    a >= 0 &&
                        e.y_unit[a] &&
                        (t.section = t.fields[e.y_property] = e.y_unit[a].key);
            }),
            (e._update_timeline_section = function(e) {
                ...
                if (a) {
                    if (a[t.y_property] != n.section) {
                        ...
                        a._sorder = this._get_dnd_order(
                            a._sorder,
                            i,
                            t._section_height[n.section]
                        );
                    }
            ...
            (e._timeline_drag_date = function(t, a) {
                ...
                if (d >= n._trace_x.length)
                    (c = e.date.add(
                        n._trace_x[n._trace_x.length - 1],
                        n.x_step,
                        n.x_unit
                    )),
                        n._end_correction &&
                            (c = new Date(c - n._end_correction));
                else {
            ...
            e.attachEvent("onEventIdChange", function() {
                ...
                t &&
                    e.matrix[t.name] &&
                    e._timeline_smart_render &&
                    (e._timeline_smart_render.clearPreparedEventsCache(),
                    e._timeline_smart_render.getPreparedEvents(t));
            }),
            e.attachEvent("onBeforeDrag", function(t, a, n) {
                if ("resize" == a) {
                    var i = n.target || n.srcElement;
                    e._getClassName(i).indexOf("dhx_event_resize_end") < 0
                        ? (e._drag_from_start = !0)
                        : (e._drag_from_start = !1);
                }
                return !0;
            });
        var E = 10,
            ...
            M = e.attachEvent("onSchedulerReady", function() {
                e.matrix &&
                    (e.event(document.body, "mousemove", g), e.detachEvent(M));
            });
        e._timeline_smart_render = {
            ...
            getViewPort: function(t, a, n, i) {
                var r = e.$container.querySelector(".dhx_cal_data"),
                    ...
                    _ = e.$container.querySelector(
                        ".dhx_timeline_scrollable_data"
                    );
                _ && void 0 === n && (n = t.getScrollValue(_)),
                    void 0 === i && (i = _ ? _.scrollTop : r.scrollTop);
                var d = {};
            ...
            getVisibleHeader: function(t, a) {
                ...
                for (var i in t._h_cols) {
                    ...
                    if (
                        this.isInXViewPort(
                            { left: r.left, right: r.left + e._cols[i] },
                            a
                        )
                    ) {
                        (n += r.div.outerHTML),
                            this._rendered_header_cache.push(
                                r.div.getAttribute("data-col-id")
                            );
                    }
                }
                return n;
            ...
            updateHeader: function(t, a, n) {
                ...
                for (
                    var i = e.$container.querySelectorAll(
                            ".dhx_cal_header > div"
                        ),
                        r = i[i.length - 1].querySelectorAll(".dhx_scale_bar"),
                        o = [],
                        _ = 0;
                    _ < r.length;
                    _++
                ...
                if (this.getVisibleHeader(t, a)) {
                    for (
                        var d = this._rendered_header_cache.slice(),
                            s = [],
                            _ = 0,
                            l = o.length;
                        _ < l;
                    ...
                    s.length &&
                        ((this._cols_to_delete = s.slice()),
                        this._deleteHeaderCells(s, t, n)),
                        d.length &&
                            ((this._cols_to_add = d.slice()),
                            this._addHeaderCells(d, t, n));
                }
            },
                            ...
                            this.isInYViewPort(
                                {
                                    ...
                                    bottom:
                                        e._label_rows[n].top +
                                        e._section_height[e.y_unit[n].key]
                                },
                                t
                            )
                        ) {
            ...
            updateLabels: function(e, t, a) {
                ...
                if (
                    (n.length ||
                        ...
                        (n = this._rendered_labels_cache.slice())),
                    this.getVisibleLabels(e, t))
                ) {
                    for (
                    ...
                    r.length &&
                        ((this._rows_to_delete = r.slice()),
                        this._deleteLabelCells(r, e, a)),
                        i.length &&
                            ((this._rows_to_add = i.slice()),
                            this._addLabelCells(i, e, a));
                }
            },
            ...
            getPreparedEvents: function(t) {
                var a;
                return (
                    this._prepared_events_cache
                        ? (a = this._prepared_events_cache)
                        : ((a = e._prepare_timeline_events(t)),
                          (a.$coordinates = {}),
                          this.cachePreparedEvents(a)),
                    a
                );
            },
            updateEvents: function(t, a) {
                ...
                var r = e.$container.querySelector(
                    ".dhx_cal_data .dhx_timeline_data_col"
                );
                if (r) {
                    for (
                        var o = 0;
                        o < this._rendered_labels_cache.length;
                        o++
                    ) {
                        ...
                        for (
                            var l = e._timeline_smart_render.getVisibleEventsForRow(
                                    t,
                                    a,
                                    n,
                                    _
                        ...
                        var g = r.querySelector(
                            '[data-section-index="' + _ + '"]'
                        );
                        s.length && this._deleteEvents(s, t, g),
                            d.length && this._addEvents(d, t, g, _);
                    }
            ...
            _deleteEvents: function(e, t, a) {
                for (var n = 0; n < e.length; n++) {
                    ...
                    i &&
                        (i.classList.contains("dhx_in_move") ||
                            a.removeChild(i));
                }
            },
                    ...
                    if (o)
                        for (var _ = 0, d = o.length; _ < d; _++) {
                            var s,
                                ...
                                c = o[_],
                                h = i + "_" + c.id;
                            n.$coordinates && n.$coordinates[h]
                                ? ((s = n.$coordinates[h].xStart),
                                  (l = n.$coordinates[h].xEnd))
                                : ((s = e._timeline_getX(c, !1, t)),
                                  (l = e._timeline_getX(c, !0, t)),
                                  n.$coordinates &&
                                      (n.$coordinates[h] = {
                                          xStart: s,
                                          xEnd: l
                                ...
                                e._timeline_smart_render.isInXViewPort(
                                    ...
                                    this._rendered_events_cache[i] ||
                                        (this._rendered_events_cache[i] = []),
                                    this._rendered_events_cache[i].push(c.id));
                        }
                }
                return r;
            },
            getVisibleRowCellsHTML: function(t, a, n, i, r) {
                for (
                    var o, _ = "", d = this._rendered_header_cache, s = 0;
                    s < d.length;
                    s++
                ) {
                    var l = d[s];
                    (o = t._h_cols[l].left - t.dx),
                        e._ignores[l]
                            ? "cell" == t.render
                                ? (_ += e._timeline_get_html_for_cell_ignores(
                                      n
                                  ))
                                : (_ += e._timeline_get_html_for_bar_ignores())
                            : "cell" == t.render
                            ? (_ += e._timeline_get_html_for_cell(
                                  l,
                                  r,
                                  t,
                                  i[r][l],
                            ...
                            : (_ += e._timeline_get_html_for_bar(
                                  l,
                                  r,
                                  t,
                                  i[r],
            ...
            getVisibleTimelineRowsHTML: function(t, a, n, i) {
                ...
                var _ = t._label_rows[i],
                    d = e.templates[t.name + "_row_class"],
                    s = { view: t, section: _.section, template: d };
                return (
                    "cell" == t.render
                        ? ((r += e._timeline_get_html_for_cell_data_row(
                              i,
                              o,
                              _.top,
                              _.section.key,
                          ...
                          (r += this.getVisibleRowCellsHTML(t, a, o, n, i)),
                          (r += "</div>"))
                        : ((r += e._timeline_get_html_for_bar_matrix_line(
                              i,
                              o,
                              _.top,
                              _.section.key,
                          ...
                          (r += e._timeline_get_html_for_bar_data_row(o, s)),
                          (r += this.getVisibleRowCellsHTML(t, a, o, n, i)),
                          (r += "</div></div>")),
                    r
                );
            ...
            updateGridRows: function(e, t) {
                this._rows_to_delete.length &&
                    this._deleteGridRows(this._rows_to_delete),
                    this._rows_to_add.length &&
                        this._addGridRows(this._rows_to_add, e, t);
            },
            ...
            _addGridRows: function(t, a, n) {
                var i = e.$container.querySelector(
                    ".dhx_cal_data .dhx_timeline_data_col"
                );
                if (i) {
                    for (
                        var r = this.getPreparedEvents(a), o = "", _ = 0;
                        _ < t.length;
                        _++
                    )
                    ...
                    for (var _ = 0; _ < t.length; _++)
                        e._timeline_finalize_section_add(
                            a,
                            a.y_unit[t[_]].key,
                            i
                        );
            ...
            updateGridCols: function(t, a) {
                for (
                    var n = this._rendered_header_cache, i = {}, r = {}, o = 0;
                    o < n.length;
                    o++
                )
                    r[n[o]] = !0;
                ...
                if (_)
                    for (
                        var d = _.querySelectorAll("[data-col-id]"), o = 0;
                        o < d.length;
                        o++
                    )
                ...
                var s = [],
                    l = [];
                for (var o in i) r[o] || s.push(o);
                for (var o in r) i[o] || l.push(o);
                s.length && this._deleteGridCols(s, t),
                    l.length && this._addGridCols(l, t, a);
            },
            _deleteGridCols: function(t, a) {
                ...
                if (n) {
                    for (
                        var i = 0;
                        i < this._rendered_labels_cache.length;
                        i++
                    ) {
                        var r;
                        if (
            ...
            _addGridCols: function(t, a, n) {
                ...
                if (i) {
                    for (
                        var r = this.getPreparedEvents(a), o = 0;
                        o < this._rendered_labels_cache.length;
                        o++
                    ) {
                        var _ = this._rendered_labels_cache[o],
